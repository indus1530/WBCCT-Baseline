...
/*        int childCount = 0;
       ...
       /* int anthroStatus = 0;
        ...
        holder.villageCode.setText(fc.get(position).getVillageCode());
...
*/
    ...
    private void editHousehold(int position) {
        ...
        try {
            MainApp.form = db.getFormByVillageHHNo(fc.get(position).getVillageCode(), fc.get(position).getHhid());
        } catch (JSONException e) {
...
//            rv = v.findViewById(R.id.FormsList);
            ...
            villageCode = v.findViewById(R.id.villageCode);
