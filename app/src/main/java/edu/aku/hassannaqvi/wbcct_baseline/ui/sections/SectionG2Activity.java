...
import edu.aku.hassannaqvi.wbcct_baseline.databinding.ActivitySectionG2Binding;
...
public class SectionG2Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesWEDMColumn(WEDMTable.COLUMN_SG2, wedm.sG2toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) startActivity(new Intent(this, SectionG3Activity.class));
