        ...
        switch (view.getId()) {
            ...
            case R.id.btnUpload:
                ...
                try {
                    ...
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(Recipient): " + e.getMessage());
                ...
                try {
                    ...
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(AnthroChild): " + e.getMessage());
                ...
                try {
                    ...
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(AnthroWRA): " + e.getMessage());
