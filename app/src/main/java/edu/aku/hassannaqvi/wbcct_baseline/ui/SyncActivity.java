...
import static edu.aku.hassannaqvi.wbcct_baseline.core.MainApp.uploadData;
import static edu.aku.hassannaqvi.wbcct_baseline.utils.AndroidUtilityKt.isNetworkConnected;
...
import edu.aku.hassannaqvi.wbcct_baseline.models.SyncModel;
import edu.aku.hassannaqvi.wbcct_baseline.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.wbcct_baseline.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.wbcct_baseline.workers.PhotoUploadWorker2;
        ...
        if (sdDir.exists()) {
            ...
            if (files.length > 0) {
                ...
                for (int i = 0; i < fcount; i++) {
                    TextView textView = new TextView(edu.aku.hassannaqvi.wbcct_baseline.ui.SyncActivity.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            WorkManager.getInstance(SyncActivity.this).getWorkInfoByIdLiveData(photoUpload.getId())
                                    .observe(edu.aku.hassannaqvi.wbcct_baseline.ui.SyncActivity.this, new Observer<WorkInfo>() {
                                        ...
                                        public void onChanged(@Nullable WorkInfo workInfo) {
                                            ...
                                            if (workInfo.getState() == WorkInfo.State.FAILED) {
                                                Toast.makeText(edu.aku.hassannaqvi.wbcct_baseline.ui.SyncActivity.this, "Failed", Toast.LENGTH_SHORT).show();
